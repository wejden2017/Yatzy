...
class OracleLogParser:
    ...
    def _parse_scripts_phase(self, lines):
        ...
        for i, line in enumerate(lines):
            ...
            if 'Nombre de scripts SQL detectes:' in line:
            ...
            if 'BILAN PHASE CATS-SCRIPT:' in line:
                in_script_phase = False
            ...
            if current_script:
                ...
                if 'Rollback disponible:' in line:
                ...
                if f'EXECUTION du script {current_script} en cours' in line:
                    continue
                ...
                if 'execute et marque comme termine (STATUT=1)' in line:
                    self.scripts.append(ScriptInfo(
                        name=current_script,
                        status='SUCCESS',
                        execution_time=script_start_time,
...
"""
    ...
    def _build_header(self):
        ...
        return f"""
        <div class="header">
            <h1>🗄️ Rapport de Déploiement Oracle</h1>
            <div class="subtitle">
                Service: {service_name} | Démarré le: {start_time}
            </div>
        </div>
        """
    ...
    def _build_summary(self):
        ...
        <div class="summary-grid">
            ...
            <div class="summary-card">
                ...
                <div class="label">Scripts Exécutés</div>
            </div>
            <div class="summary-card">
                <div class="number warning">{s['skipped_scripts']}</div>
                <div class="label">Scripts Ignorés</div>
            </div>
            <div class="summary-card">
